...
- (void)layoutWithModel:(id)model {
    _avatorImageView.image = [UIImage imageNamed:@"icon"];
    _nickLabel.text = @"计科时间";
    
    _commentImageView.image = [UIImage imageNamed:@"chat_tabbar_session_normal"];
    _commentLabel.text = @"100";
    
    _likeImageView.image = [UIImage imageNamed:@"chat_tabbar_friend_normal"];
    _likeLabel.text = @"25";
    
    _shareImageView.image = [UIImage imageNamed:@"chat_tabbar_friend_normal"];
    _shareLabel.text = @"分享";
